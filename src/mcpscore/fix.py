"""Auto-fix machinery: turn rule-proposed :class:`~mcpscore.ir.Fix`es into file
edits and diffs.
...
manual pinning — mcpscore never invents a version by resolving a registry.
...
from mcpscore.ir import Fix, McpServer, TextEdit
...
def _atomic_write(path: Path, text: str) -> None:
    tmp = path.with_name(path.name + ".mcpscore-tmp")
