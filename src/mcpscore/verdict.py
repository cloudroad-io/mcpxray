...
``82/100 (B)``. :func:`verdict` projects a :class:`~mcpscore.ir.McpServer`
(plus its :class:`~mcpscore.score.ScoreResult`) onto a traffic-light tier with a
...
from mcpscore.ir import SEVERITY_WARNING, SOURCE_STATIC
